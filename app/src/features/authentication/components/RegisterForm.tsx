      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse">
        ...
        <div className="w-full md:w-1/2 p-12 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            <h2 className="text-[#0d6e6e] text-3xl font-bold mb-8">Create an account</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#0d6e6e] text-white py-3 px-4 rounded-lg font-medium hover:bg-[#0a5555] transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
